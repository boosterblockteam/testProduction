...
const CardItem = ({ card, setIsModalOpen }: Props) => {
  ...
  return (
    <div
      ...
      ref={setNodeRef}
      key={card.id}
      className={`menu-page-item cardItem flex flex-col justify-between mb-6 last:mb-6 py-6 px-4 w-[112px] h-[55px] rounded-[16px] border border-solid border-[#7a2ff4] bg-gradient-to-t from-[#ffffff1a] to-[#ffffff00]`}
